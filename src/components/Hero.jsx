...
function Hero() {
  return (
    <section className="hero-main relative  bg-[#ffbe2d]  ">
      ...
      <img src="images/logo2.png" alt="" className=" mx-auto h-[200px] sm:h-[350px]"
      />
      {/* <img src="images/hero-btn.png" alt="" className="  h-[30px] sm:h-[80px] " /> */}
      <a href="https://www.dextools.io/app/en/solana/pair-explorer/BQh9tCLYGZp5gFVEBiEY85EfepbsVZfbTr1mSk53HEp4?t=1720532988176" className=" mx-auto font-dream box-s2  absolute left-0 right-0 top-[80%] sm:top-[50%] text-xl text-black bg-[#fcfac2] hover:bg-[#1a4093] rounded-full p-2 border-2 border-[#000]  hover:text-[#fff] w-[200px] text-center font-bold uppercase"> DexTools</a>
    </section>
  );
}
